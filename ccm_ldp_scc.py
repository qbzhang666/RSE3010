# Streamlit App: CCM with GRC, LDP, SCC – Final Version with 3 Support Criteria
...
if install_criteria == "Distance from face":
    ...
    u_install = u_install_mm / 1000  # mm to m
...
ax.plot(u_grc * 1000, scc_vals, '--', label="SCC", color='orange', lw=2)
if u_eq and p_eq:
