...
def fit_mohr_coulomb_from_exp(sigma1_exp, sigma3_exp, method='linear', threshold=1.0):
...
cohesion, friction_angle, model = fit_mohr_coulomb_from_exp(sigma1_values, sigma3_values, method=fit_method, threshold=thresh)
